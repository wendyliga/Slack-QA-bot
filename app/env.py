...
CONFLUENCE_LIMIT_PER_REQUEST=os.environ.get("CONFLUENCE_LIMIT_PER_REQUEST", 100)
CONFLUENCE_TOTAL_LIMIT_PAGES=os.environ.get("CONFLUENCE_TOTAL_LIMIT_PAGES", 5000)